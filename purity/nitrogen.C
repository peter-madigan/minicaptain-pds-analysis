...
void nitrogen() {
  ...
  for( i = start_run; i <= end_run; i+=nrun ) {
    ...
    for( int j = 0; j < nrun && i+j <= end_run && ich < nch-1; j++ ) {
      if( i+j <= 6399 && i+j >= 6379 ) 
	continue;
      if( i+j <= 6311 && i+j >= 6300 )
	continue;
  ...
  for( int j = i; j <= end_run; j++ ) {
    ...
    if( j <= 6311 && j >=6300 )
      continue;
    if( j == 6318 || j == 6379 || j == 6380 || j == 6381 || j == 6353 || j == 6352 )
      continue;
    cout << j << " ";
  ...
  hN2->GetXaxis()->SetTimeFormat("%m/%d/%y");
  ...
  htT->GetXaxis()->SetTimeFormat("%m/%d/%y");
  ...
  hO2->GetXaxis()->SetTimeFormat("%m/%d/%y");
  ...
  hr->GetXaxis()->SetTimeFormat("%m/%d/%y");
